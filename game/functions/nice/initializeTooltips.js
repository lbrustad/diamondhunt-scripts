...
function initializeTooltips()
{
	...
	s = s + generateHTMLGeneralTooltip("tooltip-marsRock", "marsRock", "Mars Rock", "A common rock found on the moon.  It can be converted into mining XP.");
	s = s + generateHTMLGeneralTooltip("tooltip-piratesParrot", "", "Pirate's Parrot", "Permanently increases your chance of finding maps from pirate's by 50%.");
	...
	s = s + generateHTMLGeneralTooltip("combat-spell-heal-tooltip", "", "", "<span style='font-size:14pt;'><br /><img src='images/largeManaStar.png' class='img-30' /> 3</span>");
	s = s + generateHTMLGeneralTooltip("combat-spell-poison-tooltip", "", "", "<span style='font-size:14pt;'><br /><img src='images/largeManaStar.png' class='img-30' /> 5</span>");
	s = s + generateHTMLGeneralTooltip("combat-spell-reflect-tooltip", "", "", "<span style='font-size:14pt;'><br /><img src='images/largeManaStar.png' class='img-30' /> 3</span>");
	s = s + generateHTMLGeneralTooltip("combat-spell-fire-tooltip", "", "", "<span style='font-size:14pt;'><br /><img src='images/largeManaStar.png' class='img-30' /> 2</span>");
	s = s + generateHTMLGeneralTooltip("combat-spell-freeze-tooltip", "", "", "<span style='font-size:14pt;'><br /><img src='images/largeManaStar.png' class='img-30' /> 5</span>");
	s = s + generateHTMLGeneralTooltip("combat-spell-ghostScan-tooltip", "", "", "<span style='font-size:14pt;'><br /><img src='images/largeManaStar.png' class='img-30' /> 0</span>");
	s = s + generateHTMLGeneralTooltip("combat-spell-teleport-tooltip", "", "", "<span style='font-size:14pt;'><br /><img src='images/largeManaStar.png' class='img-30' /> 0</span>");
	s = s + generateHTMLGeneralTooltip("combat-spell-invisibility-tooltip", "", "", "<span style='font-size:14pt;'><br /><img src='images/largeManaStar.png' class='img-30' /> 1</span>");
	s = s + generateHTMLGeneralTooltip("tooltip-monsterSigil", "", "Monster Sigil", "Monster sigils are extremely rare drops obtained from fighting in any zone.<br /><br />The drop rate is 1/10'000.");
	s = s + generateHTMLGeneralTooltip("tooltip-holidaySigil", "", "Holiday Sigil", "Holiday sigils can only be obtained during holiday events.  They become tradable every year during their respective holiday.");
	s = s + generateHTMLGeneralTooltip("tooltip-eventSigil", "", "Event Sigil", "Event sigils are only obtained after joining none-holiday related events, such as diamond hunt mmo and other.");
	...
	s = s + generateHTMLGeneralTooltip("tooltip-pirate", "", "Pirate", "Arrr, let's find some treasures!<br /><br /><span style='color:grey'>Your pirate is constantly looking for maps.  They are very rare.</span>");
	s = s + generateHTMLGeneralTooltip("tooltip-treasureMap", "", "Treasure Map", "A treasure map!  These are quite rare!<br /><br /><span style='color:grey'>You can only hold one of these at a time.</span>");
	s = s + generateHTMLGeneralTooltip("tooltip-greenTreasureMap", "", "Green Treasure Map", "A treasure map!  These maps are very rare!<br /><br /><span style='color:grey'>You can only hold one of these at a time.</span>");
	...
	s = s + generateHTMLGeneralTooltip("tooltip-diamondGlassHand", "", "Glass Hand", "<img src='images/museum.png' class='img-20' /> Wow! It's shiny even if I'm not looking towards the hand!");
	...
	s = s + generateHTMLGeneralTooltip("tooltip-glowingGoldBar", "", "Broken Stinger", "<img src='images/museum.png' class='img-20' /> This gold bar seems quite unusual.  Almost like it's glowing.");
	...
	s = s + generateHTMLGeneralTooltip("tooltip-stoneEyes", "", "Stone Eyes", "<img src='images/museum.png' class='img-20' /> A good defence against an attack is to go for the eyes.  Except these.");
	s = s + generateHTMLGeneralTooltip("tooltip-burntRemains", "", "Burnt Remains", "<img src='images/museum.png' class='img-20' /> The dragon must have gotten to this poor fellow.");
	...
	s = s + generateHTMLGeneralTooltip("tooltip-watch", "useless", "Watch", "To set the desired seed, click on the seed first (as if you were planting them) and then click on the watch.<br /><br /><span style='color:grey;font-size:10pt;'>Bob will automatically harvest crops that are ready, and replant the seed that has been set.</span>");
	...
	_d_ = 10;
	spacingY = "<b>Base heal:</b> 2 health.";
	x = "q";
	_e_ = "<b>Multiplier:</b> Heal an additional 1 health per 5 magic bonus.";
	used = used + ("<div style='font-size:16pt;font-weight:bold;'>" + currentNick + "</div>");
	used = used + ("<div>" + _c_ + "</div>");
	used = used + "<br />";
	...
	used = used + ("<img src='images/hugeManaStar.png' class='img-20' /> <b>Mana cost:</b> " + spacingX);
	used = used + "<br />";
	used = used + ("<img src='images/hourglass_grey.png' class='img-20' /> <b>Cooldown:</b> " + _d_ + " seconds");
	used = used + "</div>";
	used = used + "<div style='border:1px solid black;background-color:#EFEFEF;padding:5px;margin-top:5px;'>";
	used = used + ("<img src='images/magic_black.png' class='img-20' /> " + spacingY);
	used = used + "<br />";
	used = used + ("<img src='images/magic_grey.png' class='img-20' /> " + _e_);
	used = used + "</div>";
	used = used + "<div style='border:1px solid black;background-color:#EFEFEF;padding:5px;margin-top:5px;'>";
	used = used + ("<img src='images/keybind.png' class='img-20' /> Keybind: " + x);
	used = used + "</div>";
	...
	_d_ = 300;
	spacingY = "<b>Base poison:</b> 1 damage.";
	x = "w";
	_e_ = "<b>Multiplier:</b> Poison damaged increased by 1 per 10 magic bonus.";
	used = used + ("<div style='font-size:16pt;font-weight:bold;'>" + currentNick + "</div>");
	used = used + ("<div>" + _c_ + "</div>");
	used = used + "<br />";
	...
	currentNick = "REFLECT";
	spacingX = 3;
	_c_ = "Reflects the next attack from the enemy back to them.  Does not work on poison attacks.";
	_d_ = 30;
	spacingY = "<b>Base damage:</b> N/A";
	x = "e";
	_e_ = "<b>Buff:</b> Having a magic bonus greater than 20 will not trigger reflect if the enemy hits a 0.";
	used = used + ("<div style='font-size:16pt;font-weight:bold;'>" + currentNick + "</div>");
	used = used + ("<div>" + _c_ + "</div>");
	used = used + "<br />";
	...
	_d_ = 10;
	spacingY = "<b>Base damage:</b> 0 - 2";
	x = "r";
	_e_ = "<b>Buff:</b> +1 damage per 3 magic bonus.";
	used = used + ("<div style='font-size:16pt;font-weight:bold;'>" + currentNick + "</div>");
	used = used + ("<div>" + _c_ + "</div>");
	used = used + "<br />";
	...
	currentNick = "FREEZE";
	spacingX = 5;
	_c_ = "Freezes your enemy for a short duration";
	_d_ = 15;
	spacingY = "<b>Base Freeze Time:</b> 3 seconds";
	x = "u";
	_e_ = "<b>Buff:</b> +1 seconds per 5 magic bonus.";
	used = used + ("<div style='font-size:16pt;font-weight:bold;'>" + currentNick + "</div>");
	used = used + ("<div>" + _c_ + "</div>");
	used = used + "<br />";
	...
	spacingX = 1;
	_c_ = "Become invisibile, making your enemy miss.";
	_d_ = 30;
	spacingY = "<b>Invisibility time:</b> 2 second";
	x = "i";
	_e_ = "<b>Buff:</b> No mana cost at 20 magic bonus.";
	used = used + ("<div style='font-size:16pt;font-weight:bold;'>" + currentNick + "</div>");
	used = used + ("<div>" + _c_ + "</div>");
	used = used + "<br />";
	used = used + ("<b>Total Casts: </b> <item-" + currentNick.toLowerCase() + "Casted>0</item-" + currentNick.toLowerCase() + "Casted>");
	...
	a = [];
	a = getEncountersImgArrayForAreaareaChosen(i);
	argValue = argValue + ("<img src='images/energy.png' class='img-30' /> " + formatNumber(getEnergyReduction(10000)) + " &nbsp;&nbsp;&nbsp;&nbsp; <img src='images/hourglass_grey.png' class='img-30' /> " + formatTime(getAreaTimer(150 * 60)));
	argValue = argValue + "<br /><br />";
	...
	a = [];
	a = getEncountersImgArrayForAreaareaChosen(i);
	argValue = argValue + ("<img src='images/energy.png' class='img-30' /> " + formatNumber(getEnergyReduction(16000)) + " &nbsp;&nbsp;&nbsp;&nbsp; <img src='images/hourglass_grey.png' class='img-30' /> " + formatTime(getAreaTimer(180 * 60)));
	argValue = argValue + "<br /><br />";
	...
	a = [];
	a = getEncountersImgArrayForAreaareaChosen(i);
	argValue = argValue + ("<img src='images/energy.png' class='img-30' /> " + formatNumber(getEnergyReduction(30000)) + " &nbsp;&nbsp;&nbsp;&nbsp; <img src='images/hourglass_grey.png' class='img-30' /> " + formatTime(getAreaTimer(220 * 60)));
	argValue = argValue + "<br /><br />";
	argValue = argValue + ("<img src='" + a[1] + "' class='img-30' /> Skeleton Monks &nbsp;&nbsp;&nbsp;&nbsp;");
	argValue = argValue + ("<img src='" + a[3] + "' class='img-30' /> Dungeon Spider &nbsp;&nbsp;&nbsp;&nbsp;");
	argValue = argValue + ("<img src='" + a[5] + "' class='img-30' /> Stone Women");
	document.getElementById(i + "-fightMarker-gif").src = a[6];
	s = s + generateHTMLGeneralTooltip("tooltip-combat-map-fight-button-" + i, "", i, argValue);
	var b = "";
	argValue = "";
