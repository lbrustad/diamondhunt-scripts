...
{
	var artistTrack = "#262626";
	var GET_AUTH_URL_TIMEOUT = "#665200";
	var value_color = "grey";
	var numKeysDeleted = "#995c00";
	var postDateGmt = "#331a00";
	var _a_ = "#003366";
	var _b_ = "#000d1a";
	...
	addItemBox("lootBagLog", 0, "", "explorer-section", artistTrack, "grey", "LOOT BAG LOGS", "", false);
	addItemBox("fieldsLootBag", 0, "", "explorer-section", GET_AUTH_URL_TIMEOUT, value_color, "FIELDS", "tooltip-lootBag", false);
	addItemBox("forestLootBag", 0, "", "explorer-section", GET_AUTH_URL_TIMEOUT, value_color, "FOREST", "tooltip-lootBag", false);
	addItemBox("cavesLootBag", 0, "", "explorer-section", GET_AUTH_URL_TIMEOUT, value_color, "CAVES", "tooltip-lootBag", false);
	addItemBox("lavaDungeonLootBag", 0, "", "explorer-section", GET_AUTH_URL_TIMEOUT, value_color, "LAVA DUNG.", "tooltip-lootBag", false);
	addItemBox("northernFieldsLootBag", 0, "", "explorer-section", GET_AUTH_URL_TIMEOUT, value_color, "NORTH FIELDS", "tooltip-lootBag", false);
	addItemBox("cemeteryLootBag", 0, "", "explorer-section", GET_AUTH_URL_TIMEOUT, value_color, "CEMETERY", "tooltip-lootBag", false);
	addItemBox("oceanLootBag", 0, "", "explorer-section", GET_AUTH_URL_TIMEOUT, value_color, "OCEAN", "tooltip-lootBag", false);
	addItemBox("dungeonLootBag", 0, "", "explorer-section", GET_AUTH_URL_TIMEOUT, value_color, "CASTLE DUNGEON", "tooltip-lootBag", false);
	addItemBox("readMe", 0, "", "item-section-combat-1", artistTrack, "grey", "READ ME", "", false);
	addItemBox("fightMonsterButton", 0, "", "item-section-combat-1", artistTrack, "grey", "FIGHT NPC", "", true);
	addItemBox("fightPvpButton", 0, "", "item-section-combat-1", artistTrack, "grey", "PVP", "", true);
	addItemBox("combatLog", 1, "", "item-section-combat-1", artistTrack, "grey", "MONSTER LOG", "tooltip-combatLog", false);
	addItemBox("combatPresetsIcon", 1, "", "item-section-combat-1", artistTrack, "grey", "PRESETS", "tooltip-combatPresetsIcon", false);
	addItemBox("explorer", 1, "", "item-section-combat-1", artistTrack, "grey", "EXPLORER", "tooltip-explorer", false);
	addItemBox("heartCrystal1", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "HEART CRYSTAL", "tooltip-heartCrystal", false);
	addItemBox("heartCrystal2", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "HEART CRYSTAL", "tooltip-heartCrystal", false);
	addItemBox("bones", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "BONES", "tooltip-bones", false);
	addItemBox("ashes", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "ASHES", "tooltip-ashes", false);
	addItemBox("iceBones", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "ICE BONES", "tooltip-iceBones", false);
	addItemBox("snakeBones", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "SNAKE BONES", "tooltip-snakeBones", false);
	addItemBox("greenStoneEyes", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "STONE EYES", "tooltip-stoneEyes", false);
	addItemBox("redStoneEyes", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "STONE EYES", "tooltip-stoneEyes", false);
	addItemBox("yellowStoneEyes", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "STONE EYES", "tooltip-stoneEyes", false);
	addItemBox("blueStoneEyes", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "STONE EYES", "tooltip-stoneEyes", false);
	addItemBox("purpleStoneEyes", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "STONE EYES", "tooltip-stoneEyes", false);
	addItemBox("burntRemains", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "BURNT REMAINS", "tooltip-burntRemains", false);
	addItemBox("skeletonSkull", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "SKULL", "tooltip-skeletonSkull", false);
	addItemBox("ghostClothes", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "GHOST CLOTHES", "tooltip-ghostClothes", false);
	addItemBox("snakeskin", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "SNAKESKIN", "tooltip-snakeskin", false);
	addItemBox("batSkin", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "BATSKIN", "tooltip-batSkin", false);
	addItemBox("bearFur", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "BEAR FUR", "tooltip-bearFur", false);
	addItemBox("polarBearFur", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "POLAR BEAR FUR", "tooltip-polarBearFur", false);
	addItemBox("blackSilk", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "BLACK SILK", "tooltip-blackSilk", false);
	addItemBox("feather", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "FEATHERS", "tooltip-feather", false);
	addItemBox("fireFeather", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "FIRE FEATHERS", "tooltip-feather", false);
	addItemBox("iceFeather", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "ICE FEATHERS", "tooltip-feather", false);
	addItemBox("string", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "STRING", "tooltip-string", false);
	addItemBox("magicString", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "MAGIC STRING", "tooltip-magicString", false);
	addItemBox("thickString", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "THICK STRING", "tooltip-string", false);
	addItemBox("bowBase", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "BOW BASE", "tooltip-bowBase", false);
	addItemBox("smallSnowballs", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "SMALL SNOWBALLS", "", false);
	addItemBox("mediumSnowball", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "MEDIUM SNOWBALL", "", false);
	addItemBox("largeSnowball", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "LARGE SNOWBALL", "", false);
	addItemBox("leftBranch", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "LEFT BRANCH", "", false);
	addItemBox("rightBranch", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "RIGHT BRANCH", "", false);
	addItemBox("chain", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "CHAIN", "tooltip-cemeterySkeleton", false);
	addItemBox("skeletonHead", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "CEMETERY SKULL", "tooltip-cemeterySkeleton", false);
	addItemBox("skeletonLeftArm", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "LEFT ARM", "tooltip-cemeterySkeleton", false);
	addItemBox("skeletonRightArm", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "RIGHT ARM", "tooltip-cemeterySkeleton", false);
	addItemBox("skeletonLeftLeg", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "LEFT LEG", "tooltip-cemeterySkeleton", false);
	addItemBox("skeletonRightLeg", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "RIGHT LEG", "tooltip-cemeterySkeleton", false);
	addItemBox("dungeonSign0", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "STRANGE PANEL", "tooltip-strangeIcon", false);
	addItemBox("dungeonSign1", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "STRANGE ICON", "tooltip-strangeIcon", false);
	addItemBox("dungeonSign2", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "STRANGE ICON", "tooltip-strangeIcon", false);
	addItemBox("dungeonSign3", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "STRANGE ICON", "tooltip-strangeIcon", false);
	addItemBox("dungeonSign4", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "STRANGE ICON", "tooltip-strangeIcon", false);
	if (getItem("cookingUnlocked") == 0)
	{
		addItemBox("stew", 0, "", "item-section-combat-1", numKeysDeleted, value_color, "STEW", "tooltip-stew", false);
		addItemBox("apple", 0, "", "item-section-combat-1", numKeysDeleted, value_color, "APPLE", "tooltip-apple", false);
		addItemBox("storeBananas", 0, "", "item-section-combat-1", numKeysDeleted, value_color, "BANANAS", "tooltip-storeBananas", false);
		addItemBox("rawChicken", 0, "", "item-section-combat-1", numKeysDeleted, value_color, "RAW CHICKEN", "tooltip-rawChicken", false);
		addItemBox("cheese", 0, "", "item-section-combat-1", numKeysDeleted, value_color, "CHEESE", "tooltip-cheese", false);
		addItemBox("honey", 0, "", "item-section-combat-1", numKeysDeleted, value_color, "HONEY", "tooltip-honey", false);
	}
	addItemBox("combatVial", 0, "", "item-section-combat-1", postDateGmt, value_color, "EMPTY VIAL", "tooltip-combatVial", false);
	addItemBox("poisonCombatVial", 0, "", "item-section-combat-1", postDateGmt, value_color, "POISON VIAL", "tooltip-poisonCombatVial", false);
	addItemBox("arrow", 0, "", "item-section-combat-1", postDateGmt, value_color, "ARROWS", "tooltip-arrow", false);
	addItemBox("fireArrow", 0, "", "item-section-combat-1", postDateGmt, value_color, "FIRE ARROWS", "tooltip-fireArrow", false);
	addItemBox("iceArrow", 0, "", "item-section-combat-1", postDateGmt, value_color, "ICE ARROWS", "tooltip-iceArrow", false);
	addItemBox("arrowPlus", 0, "", "item-section-combat-1", postDateGmt, value_color, "ARROWS+", "tooltip-arrowPlus", false);
	addItemBox("rustySword", 0, "", "item-section-combat-1", postDateGmt, value_color, "RUSTY SWORD", "tooltip-rustySword", false);
	addItemBox("unlitTorch", 0, "", "item-section-combat-1", postDateGmt, value_color, "UNLIT TORCH", "tooltip-unlitTorch", false);
	addItemBox("torch", 0, "", "item-section-combat-1", postDateGmt, value_color, "TORCH", "tooltip-torch", false);
	addItemBox("stinger", 0, "", "item-section-combat-1", postDateGmt, value_color, "STINGER", "tooltip-stinger", false);
	addItemBox("brokenStinger", 0, "", "item-section-combat-1", postDateGmt, value_color, "STINGER", "tooltip-brokenStinger", false);
	addItemBox("ironDagger", 0, "", "item-section-combat-1", postDateGmt, value_color, "IRON DAGGER", "tooltip-ironDagger", false);
	addItemBox("offhandIronDagger", 0, "", "item-section-combat-1", postDateGmt, value_color, "OFFHAND DAGGER", "tooltip-offhandIronDagger", false);
	addItemBox("offhandScythe", 0, "", "item-section-combat-1", postDateGmt, value_color, "OFFHAND DAGGER+", "tooltip-offhandScythe", false);
	addItemBox("skeletonSword", 0, "", "item-section-combat-1", postDateGmt, value_color, "SKELETON SWORD", "tooltip-skeletonSword", false);
	addItemBox("bow", 0, "", "item-section-combat-1", postDateGmt, value_color, "BOW", "tooltip-bow", false);
	addItemBox("magicBow", 0, "", "item-section-combat-1", postDateGmt, value_color, "MAGIC BOW", "tooltip-magicBow", false);
	addItemBox("scythe", 0, "", "item-section-combat-1", postDateGmt, value_color, "SCYTHE", "tooltip-scythe", false);
	addItemBox("trident", 0, "", "item-section-combat-1", postDateGmt, value_color, "TRIDENT", "tooltip-trident", false);
	addItemBox("stoneMace", 0, "", "item-section-combat-1", postDateGmt, value_color, "STONE MACE", "tooltip-stoneMace", false);
	addItemBox("stoneMacePlus", 0, "", "item-section-combat-1", postDateGmt, value_color, "STONE MACE+", "tooltip-stoneMacePlus", false);
	addItemBox("yetiLeftFoot", 0, "", "item-section-combat-1", postDateGmt, value_color, "YETI'S FOOT (L)", "tooltip-yetiLeftFoot", false);
	addItemBox("yetiRightFoot", 0, "", "item-section-combat-1", postDateGmt, value_color, "YETI'S FOOT (R)", "tooltip-yetiRightFoot", false);
	addItemBox("snakeskinMask", 0, "", "item-section-combat-1", postDateGmt, value_color, "SNAKESKIN MASK", "tooltip-snakeskinMask", false);
	addItemBox("snakeskinBody", 0, "", "item-section-combat-1", postDateGmt, value_color, "SNAKESKIN BODY", "tooltip-snakeskinBody", false);
	addItemBox("snakeskinLegs", 0, "", "item-section-combat-1", postDateGmt, value_color, "SNAKESKIN LEGS", "tooltip-snakeskinLegs", false);
	addItemBox("snakeskinBoots", 0, "", "item-section-combat-1", postDateGmt, value_color, "SNAKESKIN BOOTS", "tooltip-snakeskinBoots", false);
	addItemBox("snakeskinGloves", 0, "", "item-section-combat-1", postDateGmt, value_color, "SNAKESKIN GLOVES", "tooltip-snakeskinGloves", false);
	addItemBox("bearFurMask", 0, "", "item-section-combat-1", postDateGmt, value_color, "BEAR MASK", "tooltip-bearFurMask", false);
	addItemBox("bearFurBody", 0, "", "item-section-combat-1", postDateGmt, value_color, "BEAR BODY", "tooltip-bearFurBody", false);
	addItemBox("bearFurLegs", 0, "", "item-section-combat-1", postDateGmt, value_color, "BEAR LEGS", "tooltip-bearFurLegs", false);
	addItemBox("bearFurBoots", 0, "", "item-section-combat-1", postDateGmt, value_color, "BEAR BOOTS", "tooltip-bearFurBoots", false);
	addItemBox("bearFurGloves", 0, "", "item-section-combat-1", postDateGmt, value_color, "BEAR GLOVES", "tooltip-bearFurGloves", false);
	addItemBox("polarBearFurMask", 0, "", "item-section-combat-1", postDateGmt, value_color, "POLAR MASK", "tooltip-polarBearFurMask", false);
	addItemBox("polarBearFurBody", 0, "", "item-section-combat-1", postDateGmt, value_color, "POLAR BODY", "tooltip-polarBearFurBody", false);
	addItemBox("polarBearFurLegs", 0, "", "item-section-combat-1", postDateGmt, value_color, "POLAR LEGS", "tooltip-polarBearFurLegs", false);
	addItemBox("polarBearFurBoots", 0, "", "item-section-combat-1", postDateGmt, value_color, "POLAR BOOTS", "tooltip-polarBearFurBoots", false);
	addItemBox("polarBearFurGloves", 0, "", "item-section-combat-1", postDateGmt, value_color, "POLAR GLOVES", "tooltip-polarBearFurGloves", false);
	addItemBox("batSkinMask", 0, "", "item-section-combat-1", postDateGmt, value_color, "BATSKIN MASK", "tooltip-batSkinMask", false);
	addItemBox("batSkinBody", 0, "", "item-section-combat-1", postDateGmt, value_color, "BATSKIN BODY", "tooltip-batSkinBody", false);
	addItemBox("batSkinLegs", 0, "", "item-section-combat-1", postDateGmt, value_color, "BATSKIN LEGS", "tooltip-batSkinLegs", false);
	addItemBox("batSkinBoots", 0, "", "item-section-combat-1", postDateGmt, value_color, "BATSKIN BOOTS", "tooltip-batSkinBoots", false);
	addItemBox("batSkinGloves", 0, "", "item-section-combat-1", postDateGmt, value_color, "BATSKIN GLOVES", "tooltip-batSkinGloves", false);
	addItemBox("promethiumHelmet", 0, "", "item-section-combat-1", postDateGmt, value_color, "PROM. HELM", "tooltip-promethiumHelmet", false);
	addItemBox("promethiumBody", 0, "", "item-section-combat-1", postDateGmt, value_color, "PROM. BODY", "tooltip-promethiumBody", false);
	addItemBox("promethiumLegs", 0, "", "item-section-combat-1", postDateGmt, value_color, "PROM. LEGS", "tooltip-promethiumLegs", false);
	addItemBox("promethiumBoots", 0, "", "item-section-combat-1", postDateGmt, value_color, "PROM. BOOTS", "tooltip-promethiumBoots", false);
	addItemBox("promethiumGloves", 0, "", "item-section-combat-1", postDateGmt, value_color, "PROM. GLOVES", "tooltip-promethiumGloves", false);
	addItemBox("flippers", 0, "", "item-section-combat-1", postDateGmt, value_color, "FLIPPERS", "tooltip-flippers", false);
	addItemBox("woodenShield", 0, "", "item-section-combat-1", postDateGmt, value_color, "WOOD SHIELD", "tooltip-woodenShield", false);
	addItemBox("skeletonShield", 0, "", "item-section-combat-1", postDateGmt, value_color, "SKELETON SHIELD", "tooltip-skeletonShield", false);
	addItemBox("cemeterySkeletonShield1", 0, "", "item-section-combat-1", postDateGmt, value_color, "BROKEN SHIELD", "tooltip-cemeterySkeletonShieldBroken", false);
	addItemBox("cemeterySkeletonShield2", 0, "", "item-section-combat-1", postDateGmt, value_color, "BROKEN SHIELD", "tooltip-cemeterySkeletonShieldBroken", false);
	addItemBox("cemeterySkeletonShield3", 0, "", "item-section-combat-1", postDateGmt, value_color, "BROKEN SHIELD", "tooltip-cemeterySkeletonShieldBroken", false);
	addItemBox("cemeterySkeletonShield", 0, "", "item-section-combat-1", postDateGmt, value_color, "CEMETERY SHIELD", "tooltip-cemeterySkeletonShieldBroken", false);
	addItemBox("knightsShield", 0, "", "item-section-combat-1", postDateGmt, value_color, "KNIGHT'S SHIELD", "tooltip-knightsShield", false);
	addItemBox("magicOrb", 0, "", "item-section-combat-1", postDateGmt, value_color, "MAGIC ORB", "tooltip-magicOrb", false);
	addItemBox("boneAmulet", 0, "", "item-section-combat-1", postDateGmt, value_color, "BONE AMULET", "tooltip-boneAmulet", false);
	addItemBox("boneAmuletPlus", 0, "", "item-section-combat-1", postDateGmt, value_color, "BONE AMULET+", "tooltip-boneAmuletPlus", false);
	addItemBox("invisibilityAmulet", 0, "", "item-section-combat-1", postDateGmt, value_color, "INVIS. AMULET", "tooltip-invisibilityAmulet", false);
	addItemBox("wand", 0, "", "item-section-combat-1", _a_, _b_, "WAND", "tooltip-wand", false);
	addItemBox("staff", 0, "", "item-section-combat-1", _a_, _b_, "MAGIC STAFF", "tooltip-staff", false);
	addItemBox("reaperHood", 0, "", "item-section-combat-1", _a_, _b_, "REAPER HOOD", "tooltip-reaperHood", false);
	addItemBox("reaperBody", 0, "", "item-section-combat-1", _a_, _b_, "REAPER BODY", "tooltip-reaperBody", false);
	addItemBox("reaperLegs", 0, "", "item-section-combat-1", _a_, _b_, "REAPER SKIRT", "tooltip-reaperLegs", false);
	addItemBox("reaperBoots", 0, "", "item-section-combat-1", _a_, _b_, "REAPER BOOTS", "tooltip-reaperBoots", false);
	addItemBox("reaperGloves", 0, "", "item-section-combat-1", _a_, _b_, "REAPER GLOVES", "tooltip-reaperGloves", false);
	addItemBox("cooldownRing1", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "CD RING (1)", "tooltip-cooldownRing1", false);
	addItemBox("energyRing1", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "ENERGY RING (1)", "tooltip-energyRing1", false);
	addItemBox("manaRing1", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "MANA RING (1)", "tooltip-manaRing1", false);
	addItemBox("cooldownRing2", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "CD RING (2)", "tooltip-cooldownRing2", false);
	addItemBox("energyRing2", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "ENERGY RING (2)", "tooltip-energyRing2", false);
	addItemBox("manaRing2", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "MANA RING (2)", "tooltip-manaRing2", false);
	addItemBox("cooldownRing3", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "CD RING (3)", "tooltip-cooldownRing3", false);
	addItemBox("energyRing3", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "ENERGY RING (3)", "tooltip-energyRing3", false);
	addItemBox("manaRing3", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "MANA RING (3)", "tooltip-manaRing3", false);
	addItemBox("cooldownRing4", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "CD RING (4)", "tooltip-cooldownRing4", false);
	addItemBox("energyRing4", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "ENERGY RING (4)", "tooltip-energyRing4", false);
	addItemBox("manaRing4", 0, "", "item-section-combat-1", GET_AUTH_URL_TIMEOUT, value_color, "MANA RING (4)", "tooltip-manaRing4", false);
	...
	addItemBoxMining("miner", "", "item-section-mining-1", artistTrack, "grey", "MINER", "tooltip-miner", false);
	addItemBoxMining("drills", "", "item-section-mining-1", artistTrack, "grey", "DRILLS", "tooltip-drills", false);
	addItemBoxMining("crushers", "", "item-section-mining-1", artistTrack, "grey", "CRUSHERS", "tooltip-crushers", false);
	addItemBoxMining("giantDrills", "", "item-section-mining-1", artistTrack, "grey", "GIANT DRILLS", "tooltip-giantDrills", false);
	addItemBoxMining("excavators", "", "item-section-mining-1", artistTrack, "grey", "EXCAVATORS", "tooltip-excavators", false);
	...
	addItemBox("glowingGoldBar", 0, "", "item-section-crafting-1", "#333333", "grey", "GLOWING GOLD", "tooltip-glowingGoldBars", false);
	...
	addItemBox("yellowSpices", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "SPICES", "", false);
	addItemBox("greenSpices", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "SPICES", "", false);
	addItemBox("blueSpices", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "SPICES", "", false);
	addItemBox("redSpices", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "SPICES", "", false);
	if (getItem("cookingUnlocked") == 1)
	{
		addItemBox("apple", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "APPLE", "tooltip-apple", false);
		addItemBox("bananas", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "BANANAS", "tooltip-bananas", false);
		addItemBox("storeBananas", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "BANANAS", "tooltip-storeBananas", false);
		addItemBox("coconuts", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "COCONUTS", "tooltip-coconuts", false);
		addItemBox("carrot", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "CARROTS", "tooltip-carrot", false);
		addItemBox("salad", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "MUSHROOM SALAD", "tooltip-salad", false);
		addItemBox("rawChicken", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "RAW CHICKEN", "tooltip-rawChicken", false);
		addItemBox("oysterMornay", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "OYSTER MORNAY", "tooltip-oysterMornay", false);
		addItemBox("rawGiantSnakeTail", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "SNAKE TAIL", "tooltip-giantSnakeTail", false);
		addItemBox("giantSnakeTail", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "SNAKE TAIL", "tooltip-giantSnakeTail", false);
		addItemBox("cheese", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "CHEESE", "tooltip-cheese", false);
		addItemBox("honey", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "HONEY", "tooltip-honey", false);
		addItemBox("snakeSushiShrimp", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "SNAKESKIN SUSHI", "tooltip-snakeSushiShrimp", false);
		addItemBox("snakeSushiTrout", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "SNAKESKIN SUSHI", "tooltip-snakeSushiShrimpTrout", false);
		addItemBox("snakeSushiTuna", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "SNAKESKIN SUSHI", "tooltip-snakeSushiShrimpTuna", false);
		addItemBox("seaweedChicken", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "SEAWEED CHICKEN", "tooltip-seaweedChicken", false);
		addItemBox("batSkinSushi", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "BATSKIN SUSHI", "tooltip-batSkinSushi", false);
		addItemBox("mapleSyrup", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "MAPLE SYRUP", "tooltip-mapleSyrup", false);
	}
	addItemBox("rawBearMeat", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "RAW BEAR MEAT", "tooltip-rawBearMeat", false);
	addItemBox("bearMeat", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "BEAR MEAT", "tooltip-bearMeat", false);
	addItemBox("chicken", 0, "", "item-section-cooking-1", numKeysDeleted, value_color, "CHICKEN", "tooltip-chicken", false);
};
